...
Your Mark: 5
  ...
  - Sprint Planning meeting (sprintN.md) (max 3 marks)
    ...
    Your Mark: 2, participants not recordeed 

  Planning Meetings Total Mark: 7 / 8
...
## Daily Stand-ups (max 15 marks)
  ...
  - Standup Format:
      ...
      ```
  - Each person is required to post a minimum of 3 standups per sprint (Max 15 marks; 3 marks per daily standup, 1 mark for 3 days completed)
...
## User Stories (Tracked in JIRA) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    - 2 marks = all stories in Jira Backlog follow the User Story template (As x, I want to be able to y so z)
